...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-07-28 07:24`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e0eb64c0-172a-4b7e-aba1-74911be89585.git
$ cd e0eb64c0-172a-4b7e-aba1-74911be89585
```
